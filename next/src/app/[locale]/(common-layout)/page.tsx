			...
			<DynamicCommonTabs defaultTab={tab}>
				...
				{tab === "projects" && (
					<>
						...
						{sort === "popular" ? (
							<PopularProjectList locale={locale} searchParams={searchParams} showPagination />
						) : (
							<NewProjectList locale={locale} searchParams={searchParams} showPagination />
						)}
					</>
				)}
				{tab === "pages" && (
					<>
						<SortTabs defaultSort={sort} />
						{sort === "popular" ? (
							<PopularPageList locale={locale} searchParams={searchParams}  showPagination />
						) : (
							<NewPageList locale={locale} searchParams={searchParams} showPagination />
						)}
					</>
				)}
			</DynamicCommonTabs>
