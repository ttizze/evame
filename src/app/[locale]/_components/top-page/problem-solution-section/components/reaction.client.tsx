...
const ReactionItem = ({ reaction }: { reaction: Reaction }) => {
  ...
  return (
    <div className="flex items-center gap-2 rounded-full bg-white/90 px-3 py-2 shadow-md dark:bg-gray-800/90">
      ...
      <div className="flex items-center gap-2">
        ...
        {renderIcon()}
        {reaction.content && (
          <span className="max-w-[200px] truncate text-gray-500 text-sm">
            {reaction.content}
          </span>
        )}
      </div>
