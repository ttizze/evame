...
describe("Editor Configuration Integration", () => {
	it("configureEditorの出力にtransformPastedHTMLを保持する", () => {
	 ...
	 */
	it("現在のeditor実装がtransformPastedHTMLを失うことを検出する", () => {
