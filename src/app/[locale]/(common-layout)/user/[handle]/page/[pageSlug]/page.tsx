...
export default async function Page({
  ...
  return (
    <>
      ...
      <article className="prose dark:prose-invert lg:prose-lg mx-auto mb-20 w-full prose-a:underline">
        ...
        {pageDetail.children && pageDetail.children.length > 0 && (
          <div className="mt-8 rounded-lg border p-4">
            <h2 className="mb-4 font-bold text-xl">子ページ</h2>
        ...
        <div className="mt-8">
          <div className="mt-8" id="comments">
            <div className="flex items-center gap-2 py-2">
              <h2 className="not-prose font-bold text-2xl">Comments</h2>
            </div>
