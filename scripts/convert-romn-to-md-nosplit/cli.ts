...
import { getChildElements } from "../convert-romn-to-md/tei";
...
export async function convertXmlFileToMarkdownNoSplit(
	filePath: string,
	outputDir: string,
): Promise<void> {
...
export async function runConversionCliNoSplit(): Promise<void> {
	...
	const outputDir = path.resolve(process.cwd(), "tipitaka-md-nosplit");
