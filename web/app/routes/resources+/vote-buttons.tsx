...
import { z } from "zod";
import { VoteButton } from "~/routes/$locale+/$userName+/page+/$slug+/components/sourceTextAndTranslationSection/VoteButton";
import type { TranslationWithVote } from "~/routes/$locale+/$userName+/page+/$slug+/types";
